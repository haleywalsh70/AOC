...
Le renne transporte joyeusement un rapporteur et l'ajoute à la pile. Quelle est la somme des scores de tous les points de départ des sentiers sur votre carte topographique ?

REPONSE: 461

--- Deuxième partie ---
Le renne passe quelques minutes à examiner votre carte des sentiers de randonnée avant de se rendre compte de quelque chose, de disparaître pendant quelques minutes et de revenir enfin avec un autre morceau de papier légèrement carbonisé.

Le papier décrit une deuxième façon de mesurer un point de départ de sentier, appelée sa cote. La cote d'un point de départ de sentier est le nombre de sentiers de randonnée distincts qui commencent à ce point de départ. Par exemple :
...
..8765.
..9....
La carte ci-dessus ne comporte qu'un seul point de départ de sentier ; sa cote est de 3 car il y a exactement trois sentiers de randonnée distincts qui commencent à cet endroit :
...
4.6789
56789.
Voici le plus grand exemple de avant :
