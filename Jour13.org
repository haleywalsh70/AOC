...
Pour la troisième machine à pinces, le moyen le moins cher de gagner le prix est d'appuyer 38 fois sur le bouton A et 86 fois sur le bouton B. Cela coûterait un total de 200 jetons.
...
--- Deuxième partie ---
Alors que vous vous apprêtez à gagner le premier prix, vous découvrez que la griffe est loin d'être là où vous l'espériez. En raison d'une erreur de conversion d'unité dans vos mesures, la position de chaque prix est en fait 10000000000000 plus haute sur les axes X et Y !
