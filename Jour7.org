...
Les ingénieurs ont juste besoin du résultat d'étalonnage total, qui est la somme des valeurs de test des seules équations qui pourraient éventuellement être vraies. Dans l'exemple ci-dessus, la somme des valeurs de test pour les trois équations répertoriées ci-dessus est 3749.

Déterminez quelles équations pourraient être vraies. Quel est leur résultat d'étalonnage total ?

REPONSE: 6231007345478

--- Deuxième partie ---
Les ingénieurs semblent inquiets ; le résultat d'étalonnage total que vous leur avez donné est loin d'être dans les tolérances de sécurité. C'est alors que vous repérez votre erreur : des éléphants bien cachés tiennent un troisième type d'opérateur.
...
Maintenant, en plus des trois équations qui pourraient être rendues vraies en utilisant seulement l'addition et la multiplication, l'exemple ci-dessus a trois autres équations qui peuvent être rendues vraies en insérant des opérateurs :
...
L'addition des six valeurs de test (les trois qui pouvaient être faites avant en utilisant seulement + et * plus les trois nouvelles qui peuvent maintenant être faites en utilisant également ||) produit le nouveau résultat d'étalonnage total de 11 387.

En utilisant vos nouvelles connaissances sur les cachettes des éléphants, déterminez quelles équations pourraient éventuellement être vraies. Quel est leur résultat d'étalonnage total ?

REPONSE: 333027885676693
